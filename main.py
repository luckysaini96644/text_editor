...
# signUp_button = tkinter.Button(root,text="SignUp",bg="#FF3399", fg="#FFFFFF", font=("Arial", 16), command=signUp).pack(fill=3, expand=90, side=Left)
#
...
# signUp_button.grid(row=4,column=0 ,columnspan=2 ,pady=35)
